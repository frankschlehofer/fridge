...
function SignUpPage() {
    ...
    return (
        ...
        >
            {/* Entire box */}
            <div 
                className="flex flex-col items-center justify-center w-full h-full min-w-128 min-h-128 max-h-200 max-w-164
            ...
            >
                <div className="font-[ubuntu] text-[#4E937A] text-5xl font-bold mb-4">
                    Create your Fridge
                </div>
                ...
                <div className="items-start ">
                    ...
                    <div className="mb-10 p-3 w-128 border-3 border-gray-300 text-xl font-light hover:border-cyan-400">
                        <input 
                    ...
                    <button 
                        className={`mb-4 py-3 w-128 rounded text-xl text-white font-bold  transition flex items-center justify-center
